...
```sh
prompt> python3 paging-policy.py --addresses=0,1,2,0,1,3,0,3,1,2,1 
...
```sh
prompt> python3 paging-policy.py --help
...
```sh
prompt> python3 paging-policy.py -s 10 -n 3
.. .
...
```sh
prompt> python3 paging-policy.py -s 10 -n 3 -c
...
Solving...
